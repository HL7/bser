Instance: bundle-batch-response-hypertension-request-supp-info
InstanceOf: BSeRBundleBatchResponseReferralSupportingInfo
Title: "Batch Response Bundle - Hypertension Request Supporting Information"
Description: "This Bundle is a batch-response of resources making up the supporting information for an hypertension referral request. It is in reponse to the corresponding batch query Bundle."
Usage: #example
