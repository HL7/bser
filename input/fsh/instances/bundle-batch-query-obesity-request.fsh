...
Title: "Batch Query Bundle - Obesity Request"
Description: "This bundle is a batch of requests to the FHIR RESTful API for referral request supporting information for a obesity referral. Each entry is used to represent a RESTful API request."
Usage: #example
