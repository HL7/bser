...
{{render:BSeRHypertensionRequestSupportBundleUML}}</center>

---

### **Structure Definition**

{{profile:BSeRHypertensionRequestSupportBundle, expand}}
...
{{table:BSeRHypertensionRequestSupportBundle, expand}}
