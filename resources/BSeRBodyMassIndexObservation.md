### **BSeR Body Mass Index Observation**
...
{{render:bserbodymassindexobservationuml}}</center>

---

### **Structure Definition**

{{profile:bserbodymassindexobservation, expand}}
...
{{table:bserbodymassindexobservation, expand}}
